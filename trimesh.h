...
public:
    ...
    public:
        ...
        //returns the newFlag for this vertex
        inline bool& isNew() { return newFlag; }
        inline bool  isNew() const { return newFlag; }
        
        //returns the newFlag for this vertex
        inline Vertex*& ParentVertex() { return parentVertex; }
        inline Vertex*  ParentVertex() const { return parentVertex; }
    ...
    private:
        ...
        Vertex() : e(NULL) {}
        Vertex(const Vector& pos) : p(pos), e(NULL), newFlag(false), parentVertex(NULL){}
        ~Vertex() {}
    ...
    public:
        ...
        inline bool& isSplit() { return isSplitFlag; }
        inline bool  isSplit() const { return isSplitFlag; }
    ...
    private:
        ...
        HalfEdge() : v(NULL), t(NULL), p(NULL), n(NULL), f(NULL), isSplitFlag(false){}
        ~HalfEdge() {}
